...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variation_id: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    service_id: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiWorkshopServiceWorkshopService
  ...
  info: {
    displayName: 'Workshop_Service';
    pluralName: 'workshop-services';
    singularName: 'workshop-service';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWorkshopWorkshop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    workshop_id: Schema.Attribute.Relation<
      ...
      'api::workshop-service.workshop-service'
    >;
    workshop_status: Schema.Attribute.Enumeration<['Active', 'Inactive']>;
  };
}
